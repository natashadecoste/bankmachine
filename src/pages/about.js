...
export default class About extends React.Component{
    ...
    updateInfo = (stateChange) => {
        var index = information.map(function (info) { return info.title; }).indexOf(stateChange.target.textContent);
        this.setState({
            currentPage: index
        })
    }
